...
func FlyURL() string {
	return "https://cahyaadityapurnama-final-project-be2745686.fly.dev" // TODO: replace this
}

func main() {
	//TODO: hapus jika sudah di deploy di fly.io
	os.Setenv("DATABASE_URL", "postgres://postgres:cahya123@localhost:5432/test_db_camp")
